<?php
/**
* @brief 未被捕获的异常，会流转到此类的errorAction下处理
 ...
 */
class ErrorController extends Controller_Intenal {
    ...
    public function errorAction($exception) {
        ...
        XLogKit::logger('exception')->warn("[error controller] [code: {$errCode}] [msg: {$errMsg}]");
